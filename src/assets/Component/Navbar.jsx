            ...
            <div className='w-10/12 mx-auto flex justify-between items-center py-2 font-bold '>
                ...
                <div className='flex gap-6'>
                    <div className='relative flex items-center gap-1 border border-2 border-gray-300 rounded-full  px-5'>
                        ...
                        <button onClick={()=> toast('🫣 OH! sorry this is still in progress')}  className='flex gap-4 items-center rounded-full cursor-pointer  py-3 px-6  ' >  Login</button>
                    </div>
                    <button onClick={()=> toast('😩 OH! sorry this is still in progress ')}  className='cursor-pointer bg-linear-500 from-[#4F39F6] to-[#9514FA] text-white py-3 px-6 rounded-full'>Get Started</button>
                </div>
            </div>
            {
                value ?
